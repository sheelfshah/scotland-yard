...
class Game:
    ...
    def __init__(self, id):
        start_positions = [29, 26, 103, 53, 132, 112, 198,
                           155, 197, 34, 13, 141, 50, 94, 91, 138, 117, 174]
        ...
        self.transports = [[4, 3, 3, 5, 2], [10, 8, 4], [
            10, 8, 4], [10, 8, 4], [10, 8, 4], [10, 8, 4]]
        self.mrxVehicle = "null"
        self.dictionary = {"taxi": 0, "bus": 1,
                           "underground": 2, "blackticket": 3, "double": 4}
        self.gameOver = False
